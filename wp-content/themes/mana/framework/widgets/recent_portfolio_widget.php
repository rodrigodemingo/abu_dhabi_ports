...
class tt_RecentPortfolioWidget extends WP_Widget {

    function tt_RecentPortfolioWidget() {
        $widget_ops = array('classname' => 'ttrecentportfoliostswidget', 'description' => 'Advanced recent posts.');
        parent::WP_Widget(false, ': Recent Portfolio', $widget_ops);
    }
...
add_action('widgets_init', create_function('', 'return register_widget("tt_RecentPortfolioWidget");'));
