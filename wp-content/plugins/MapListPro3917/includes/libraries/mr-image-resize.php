...
add_action('delete_attachment', 'mlp_mr_delete_resized_images');

function mlp_mr_image_resize($url, $width=null, $height=null, $crop=true, $align='c', $retina=false) {

  global $wpdb;

  // Get common vars (func_get_args() only get specified values)
  $common = mlp_mr_common_info($url, $width, $height, $crop, $align, $retina);
...
function mlp_mr_common_info($url, $width, $height, $crop, $align, $retina) {
...
function mlp_mr_delete_resized_images($post_id) {
