...
if (!class_exists('VC_Extensions_Tabs')) {
    ...
    class VC_Extensions_Tabs {
            ...
            "params" => array(
              array(
                ...
                "value" => __("[tabitem]
                  ...
                  [/tabitem]", "vc_tabs_cq"), "description" => __("Enter content for each block here. Divide each with paragraph (Enter).", "vc_tabs_cq") ),
              array(
                "type" => "colorpicker",
                "holder" => "div",
                "class" => "",
        ...
        function cq_vc_tabs_func($atts, $content=null) {
