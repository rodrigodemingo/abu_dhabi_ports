...
if (!class_exists('VC_Extensions_Parallax')) {
    ...
    class VC_Extensions_Parallax {
          ...
          wpb_map( array(
            ...
            "params" => array(
              ...
              array(
                ...
                <a href='http://codecanyon.net/user/sike?ref=sike'>Visit my profile</a> for more works. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</div>
        ...
        function cq_vc_parallax_func($atts, $content=null) {
          ...
          wp_register_script('vc_parallax_cq_script', plugins_url('js/init.js', __FILE__), array('jquery', 'modernizr', 'imagescroll'));
