<?php
/*
Plugin Name: Ultimate Addons for Visual Composer 3.9
...
function uvc_plugin_activate()
{
	...
	if(array_key_exists(get_current_theme(), $themes))
	{
		if(!get_option('ultimate_custom_vc_row'))
			update_option('ultimate_custom_vc_row',$themes[get_current_theme()]);
	}
}
