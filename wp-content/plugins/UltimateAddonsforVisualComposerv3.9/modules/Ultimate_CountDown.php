...
if(!class_exists('Ultimate_CountDown'))
{
	class Ultimate_CountDown
	{
		...
		function count_down_scripts() {
			wp_register_script("jquery.timecircle",plugins_url("../assets/min-js/jquery.countdown_org.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
			wp_register_script("jquery.countdown",plugins_url("../assets/min-js/count-timer.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
		}
				...
				vc_map(
					array(
					   ...
					   "params" => array(
							...
							array(
								"type" => "heading",
								"sub_heading" => "<span style='display: block;'><a href='http://bsf.io/szdd2' target='_blank'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
