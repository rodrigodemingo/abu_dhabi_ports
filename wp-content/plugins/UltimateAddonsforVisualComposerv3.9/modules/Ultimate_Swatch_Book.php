...
if(!class_exists('Ultimate_Swatch_Book')){
	class Ultimate_Swatch_Book{
		...
		{
			wp_register_script("modernizr-79639-js",plugins_url("../assets/min-js/modernizr.custom.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
			wp_register_script("swatchbook-js",plugins_url("../assets/min-js/jquery.swatchbook.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
		}
