...
if(!class_exists('ULT_HotSpot')) {
	class ULT_HotSpot {
		...
		function ult_hotspot_callback( $atts, $content = null ) {
			...
			$output  = "<div class='ult_hotspot_container cqtooltip-wrapper ".$el_class."' style=".$cust_size.">";
			$output .= "  <img class='ult_hotspot_image' src=".$mnimg[0]." style=".$cust_size." />";
			$output .= "     <div class='utl-hotspot-items cq-hotspots'>".do_shortcode($content)."</div>";
		...
		function ult_hotspot_items_callback( $atts, $content = null ){
		   global $hotspot_icon, $hotspot_icon_bg_color, $hotspot_icon_color, $hotspot_icon_size;
			...
			$content = wpb_js_remove_wpautop($hotspot_content, false); // fix unclosed/unwanted paragraph tags in $content
		  ...
		  if($tooltip_custom_border_size!=''){             
			...
			$output .= "   <a ".$data." class='ult-tooltip tooltipstered cq-tooltip' href='#'>";
				$output .= $icon_inline;
				$output .= "<span class='hotspot-tooltip-content'>".$content."</span>";
			$output .= "  </a>";
			$output .= "</div>";
					  ...
					  "params" => array(
							...
							array(
								...
								array(
									"type" => "colorpicker",
									"class" => "",
									"heading" => __("Tooltip Background Color", "ultimate_vc"),
								...
								array(
									...
									"class" => "",
									"value" => "300",
									"heading" => __("Tooltip Width", 'ultimate_vc'),
									"param_name" => "tooltip_width",
									"group" => "Tooltip",
									"suffix"  => "px",
									/*"description" => __("Tooltip width.", 'ultimate')*/
								),
								array(
									"type" => "dropdown",
									"class" => "",
									"heading" => __("Tooltip Trigger On", 'ultimate_vc'),
								...
								array(
									"type" => "dropdown",
									"class" => "",
									"heading" => __("Tooltip Position", 'ultimate_vc'),
								...
								array(
									...
									"heading" => __("Tooltip Border Thickness","ultimate_vc"),
									...
									"label_color"   => __("Tooltip Border Color","ultimate_vc"),       //  label for 'border color'   default 'Border Color'
									"label_radius"  => __("Tooltip Border Radius","ultimate_vc"),        //  label for 'radius'  default 'Border Redius'
								...
								array(
									"type" => "ult_switch",
									"class" => "",
									"heading" => __("Tooltip Arrow", "ultimate_vc"),
								...
								array(
									"type" => "dropdown",
									"class" => "",
									"heading" => __("Tooltip Appear Animation", 'ultimate_vc'),
								...
								array(
									...
									"heading" => __("Tooltip Padding", "ultimate_vc"),
