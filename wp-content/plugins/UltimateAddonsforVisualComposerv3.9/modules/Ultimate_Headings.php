...
if(!class_exists("Ultimate_Headings")){
	class Ultimate_Headings{
		...
		{
			wp_register_style("ultimate-headings-style",plugins_url("../assets/min-css/headings.min.css",__FILE__),array(),ULTIMATE_VERSION);
			wp_register_script("ultimate-headings-script",plugins_url("../assets/min-js/headings.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
		}
				...
				vc_map(
					array(
					   ...
					   "params" => array(
							...
							array(
								"type" => "heading",
								"sub_heading" => "<span style='display: block;'><a href='http://bsf.io/8v9sy' target='_blank'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
		...
		function ultimate_headings_shortcode($atts, $content = null){
			...
			// responsive {main} heading styles
		  	$args = array(
		  		'target'		=>	'.'.$uid.' .uvc-main-heading '.$heading_tag,
		  		'media_sizes' 	=> array(
			...
			$output = '<div id="'.$id.'" class="uvc-heading '.$uid.' '.$el_class.'" data-hspacer="'.$spacer.'" '.$data.' data-halign="'.$alignment.'" style="text-align:'.$alignment.'">';
