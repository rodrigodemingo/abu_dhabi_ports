...
if(!class_exists('AIO_Stats_Counter'))
{
	class AIO_Stats_Counter
	{
		...
		{
			wp_register_script("front-js",plugins_url("../assets/min-js/countUp.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION);
		}
					...
					array(
					   ...
					   "params" => array(
						  ...
						  array(
							...
							array(
								"type" => "heading",
								"sub_heading" => "<span style='display: block;'><a href='http://bsf.io/t23kn' target='_blank'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
