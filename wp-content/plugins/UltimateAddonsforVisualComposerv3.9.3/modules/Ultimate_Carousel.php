...
if(!class_exists("Ultimate_Carousel")){
	class Ultimate_Carousel{
		...
		function ultimate_front_scripts(){
			wp_register_script("ult-slick",plugins_url("../assets/min-js/slick.min.js",__FILE__),array('jquery'),ULTIMATE_VERSION,false);
			wp_register_script("ult-slick-custom",plugins_url("../assets/min-js/slick.custom.min.js",__FILE__),array('jquery','ult-slick'),ULTIMATE_VERSION,false);
		}
						...
						"params" => array(
							...
							*/
							...
							array(
								...
								"param_name" => "rtl",
								"value" => array("Turn on RTL mode" => "true"),
								"description" => __("","smile"),
								"group"=> "Advanced",
						  	),
							*/
							...
							array(
								"type" => "heading",
								"sub_heading" => "<span style='display: block;'><a href='http://bsf.io/bzyci' target='_blank'>".__("Watch Video Tutorial","ultimate_vc")." &nbsp; <span class='dashicons dashicons-video-alt3' style='font-size:30px;vertical-align: middle;color: #e52d27;'></span></a></span>",
