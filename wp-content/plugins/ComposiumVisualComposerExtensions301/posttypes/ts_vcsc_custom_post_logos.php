<?php
	...
	function TS_VCSC_Logo_Meta_Boxes($meta_boxes) {
		...
		$meta_boxes['ts_vcsc_team_basic'] = array(
			...
			'fields' 					=> array(
				array('name' => 'Use the "Featured Image" section to apply the logo itself to this post.', 'desc' => 'The "TS Logo" post type can also be used to create portfolios.', 'type' => 'title', 'id' => $prefixA . 'title'),
	...
	add_action('admin_enqueue_scripts',							'TS_VCSC_Logos_Post_Files');
