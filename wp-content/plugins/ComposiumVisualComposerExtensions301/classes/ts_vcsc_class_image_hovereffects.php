	...
	class TS_Image_Hover_Effects {
        ...
        function TS_VCSC_Image_Hover_Effects_Function ($atts, $content = null) {
            ...
            extract( shortcode_atts( array(
				...
				'effect_style_icons'			=> 'ts-hover-effect-hera',
			...
			if ($hover_frontent == "false") {
				if (($hover_event != "none") && ($hover_event == "popup")) {
					...
					// HTML5 Video Popup
					$linkString .= '<a id="' . $hover_image_id . '-trigger" href="#' . $modal_id . '" class="ts-hover-image-link ' . $hover_image_id . '-parent nch-holder nch-lightbox-media" ' . $lightbox_dimensions . ' style="" data-title="' . $title_text . '" data-type="html" rel="' . ($lightbox_group == "true" ? "nachogroup" : $lightbox_group_name) . '" data-share="0" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" data-color="' . $lightbox_backlight_selection . '">View</a>';
				} else if (($hover_event != "none") && ($hover_event == "link")) {
					// Link Event
					$linkString .= '<a id="' . $hover_image_id . '-trigger" class="ts-hover-image-link" href="' . $a_href . '" target="' . $a_target . '" title="' . $a_title . '">View</a>';
				} else {
					// No Link Event
					$linkString .= '';
				}
			...
			$output .= '<div class="ts-hover-effects-container ts-image-effects-frame ts-image-hover-frame" style="margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px;">';
				if ((strlen($tooltip_content_html) != 0) || (strlen($tooltip_content) != 0)) {
					...
					if ($overlay_handle_show == "true") {
						...
						$output .= '<div class="ts-hover-effects-grid">';					
							$output .= '<figure class="' . $effect_style . ' ' . $Permanent_Class . '">';
								$output .= '<img src="' . $hover_image[0] . '" data-width="' . $hover_image[1] . '" data-height="' . $hover_image[2] . '" data-ratio="' . ($hover_image[1] / $hover_image[2]) . '" alt=""/>';
									...
									if (($effect_style == "ts-hover-effect-lily") || ($effect_style == "ts-hover-effect-julia")) {
										...
										if ($effect_style == "ts-hover-effect-zoe") {
											$output .= '<p class="icon-links" style="color: ' . $content_color_icons . '">';
												if (($a_href_content1 != "") && ($content_link1_icon != "")) {
													$output .= '<a href="' . $a_href_content1 . '" target="' . $a_target_content1 . '" title="' . $a_title_content1 . '"><span style="color: ' . $content_color_icons . '" class="ts-teammate-icon ' . $content_link1_icon . '"></span></a>';
												}
												if (($a_href_content2 != "") && ($content_link2_icon != "")) {
													$output .= '<a href="' . $a_href_content2 . '" target="' . $a_target_content2 . '" title="' . $a_title_content2 . '"><span style="color: ' . $content_color_icons . '" class="ts-teammate-icon ' . $content_link2_icon . '"></span></a>';
												}
												if (($a_href_content3 != "") && ($content_link3_icon != "")) {
													$output .= '<a href="' . $a_href_content3 . '" target="' . $a_target_content3 . '" title="' . $a_title_content3 . '"><span style="color: ' . $content_color_icons . '" class="ts-teammate-icon ' . $content_link3_icon . '"></span></a>';
												}
											$output .= '</p>';
										...
										if (($effect_style == "ts-hover-effect-hera") || ($effect_style == "ts-hover-effect-terry") || ($effect_style == "ts-hover-effect-kira")) {
											$output .= '<p style="color: ' . $content_color_icons . '">';
												if (($a_href_content1 != "") && ($content_link1_icon != "")) {
													$output .= '<a href="' . $a_href_content1 . '" target="' . $a_target_content1 . '" title="' . $a_title_content1 . '"><i style="color: ' . $content_color_icons . '" class="ts-teammate-icon ' . $content_link1_icon . '"></i></a>';
												}
												if (($a_href_content2 != "") && ($content_link2_icon != "")) {
													$output .= '<a href="' . $a_href_content2 . '" target="' . $a_target_content2 . '" title="' . $a_title_content2 . '"><i style="color: ' . $content_color_icons . '" class="ts-teammate-icon ' . $content_link2_icon . '"></i></a>';
												}
												if (($a_href_content3 != "") && ($content_link3_icon != "")) {
													$output .= '<a href="' . $a_href_content3 . '" target="' . $a_target_content3 . '" title="' . $a_title_content3 . '"><i style="color: ' . $content_color_icons . '" class="ts-teammate-icon ' . $content_link3_icon . '"></i></a>';
												}
												if (($a_href_content4 != "") && ($content_link4_icon != "")) {
													$output .= '<a href="' . $a_href_content4 . '" target="' . $a_target_content4 . '" title="' . $a_title_content4 . '"><i style="color: ' . $content_color_icons . '" class="ts-teammate-icon ' . $content_link4_icon . '"></i></a>';
												}
											$output .= '</p>';
										}
				...
				if (($hover_frontent == "false") && ($hover_event == "popup")) {
					$output .= '<div id="' . $hover_image_id . '" class="ts-modal-content nch-hide-if-javascript ' . $el_class . '" style="display: none; padding: ' . $lightbox_custom_padding . 'px; ' . $lightbox_background . '">';
                ...
                vc_map( array(
                    ...
                    "params"                            => array(
						...
						array(
							...
							"size"						=> "14",
							"value"						=> "",
							"message"            		=> __( "Click events are only available for style types with text, but not for styles with icons.", "ts_visual_composer_extend" ),
							"description"       		=> __( "", "ts_visual_composer_extend" ),
							"dependency"            	=> array( 'element' => "effect_style_type", 'value' => 'icons' ),
							"group" 					=> "Event",
						),
