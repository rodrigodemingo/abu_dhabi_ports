		...
		function TS_VCSC_Image_Hotspot_Container ($atts, $content = null) {
			...
			if ($hotspot_frontend == "false") {
				if ($hotspot_break == "true") {
					$output .= '<div id="' . $image_hotspot_id . '-fullwidth" class="ts-image-full-frame ' . $css_class . '" style="width: 100%; height: 100%; margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px;" ' . $breakouts_data . ' data-large="' . $hotspot_large . '" data-medium="' . $hotspot_medium . '">';
					...
					$output .= '<div id="' . $image_hotspot_id . '" class="' . $css_class . '" style="margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px; height: 100%; width: 100%;" data-large="' . $hotspot_large . '" data-medium="' . $hotspot_medium . '">';	
				}
