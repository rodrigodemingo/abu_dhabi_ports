	...
	class TS_Timelines {
        ...
        function TS_VCSC_Add_Timeline_Elements() {
			...
			if (function_exists('vc_map')) {
				vc_map( array(
					"name"                      	=> __( "TS Timeline Item", "ts_visual_composer_extend" ),
            ...
            if (function_exists('vc_map')) {
                vc_map(array(
					"name"                              => __("TS Isotope Timeline", "ts_visual_composer_extend"),
