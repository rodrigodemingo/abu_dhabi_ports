	...
	class TS_iPresenter {
		...
		function TS_VCSC_iPresenter_Item ($atts, $content = null) {
			...
			$output .= '<div class="ts-ipresenter-step clearFixMe" ' . $animation . ' data-thumbnail="' . $thumbnail_image[0] . '">';
				if ($lightbox_image == "true") {
					$output .= '<a href="' . $ipresenter_image[0] . '" class="ts-ipresenter-lightbox nch-lightbox-media" data-title="' . $title . '" rel="' . ($lightbox_group == "true" ? "nachogroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" ' . $nacho_color . '>';
				}
					$output .= '<img class="ts-ipresenter-image" src="' . $ipresenter_image[0] . '" />';
				if ($lightbox_image == "true") {
					$output .= '</a>';
				}
				...
				if (($button_text != '') && ($button_link != '')) {
					...
					//$output .= '<div class="ts-ipresenter-button" style="height: 60px; margin:0; padding: 0; position: relative;"></div>';
				}
			$output .= '</div>';
		...
		function TS_VCSC_iPresenter_Container ($atts, $content = null){
			...
			$general_data						= 'data-autoheight="' . $autoheight . '" data-fixedheight="' . $fixedheight . '" data-setheight="' . $height . '" data-height="" data-width="" data-animationspeed="' . $animation_speed . '" data-randomstart="' . $random_start . '" data-zoomeffect="' . $zoomeffect . '"';
			...
			$output .= '<div id="' . $ipresenter_id . '" class="' . $css_class . ' clearFixMe" style="margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px;">';
				$output .= '<div class="ts-ipresenter-container clearFixMe" style="" ' . $general_data . ' ' . $navigation_data . ' ' . $autoplay_data . ' ' . $timer_data . '>';
					$output .= '<div class="ts-ipresenter-main clearFixMe">';
