			...
			echo '<div class="ts-vcsc-section-main">';
				...
				echo '<div class="ts-vcsc-section-content">';
					echo '<div style="margin-top: 10px;">';
						...
						echo '<a class="button-secondary" style="width: 200px; margin: 0 5px 0 0; text-align: center;" href="http://tekanewascripts.info/composer/manual/" target="_blank"><img src="' . TS_VCSC_GetResourceURL('images/other/ts_vcsc_manual_icon_16x16.png') . '" style="width: 16px; height: 16px; margin-right: 10px;">Manual</a>';
						echo '<a class="button-secondary" style="width: 200px; margin: 0 5px 0 0; text-align: center;" href="http://support.tekanewascripts.info/forums/forum/wordpress-plugins/visual-composer-extensions/" target="_blank"><img src="' . TS_VCSC_GetResourceURL('images/other/ts_vcsc_support_icon_16x16.png') . '" style="width: 16px; height: 16px; margin-right: 10px;">Support Forum</a>';
						echo '<a class="button-secondary" style="width: 200px; margin: 0 5px 0 0; text-align: center;" href="http://support.tekanewascripts.info/category/visual-composer-extensions/" target="_blank"><img src="' . TS_VCSC_GetResourceURL('images/other/ts_vcsc_knowledge_icon_16x16.png') . '" style="width: 16px; height: 16px; margin-right: 10px;">Knowledge Base</a>';
					echo '</div>';
			...
			echo '<div class="ts-vcsc-section-main">';
				...
				echo '<div class="ts-vcsc-section-content slideFade" style="display: none;">';
					echo '<table class="ts-vcsc-system-information-table" style="width: 100%;">';
						...
						$system_summary .= 'MySQL Version: ' . mysql_get_server_info() . '<br/>';
			...
			echo '<div class="ts-vcsc-section-main">';
				...
				echo '<div class="ts-vcsc-section-content slideFade" style="display: none;">';
					echo '<table class="ts-vcsc-system-information-table" style="width: 100%;">';
						...
						$system_summary .= 'PHP Memory Limit: ' . ini_get('memory_limit') . 'B<br/>';
