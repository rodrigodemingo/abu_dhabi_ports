<?php
	...
	function TS_VCSC_Admin_Notice_Version() {
		echo '<div class="updated"><p>The <strong>Composium - Visual Composer Extensions</strong> add-on requires <strong>Visual Composer</strong> version 4.0.0 or greater.</p></div>';	
	}
	...
	function TS_VCSC_On_New_BlogSite($blog_id, $user_id, $domain, $path, $site_id, $meta) {
		...
		if (function_exists('is_multisite') && is_multisite()) {
			if (is_plugin_active_for_network('ts-visual-composer-extend/ts-visual-composer-extend.php')) {
				...
				array('VISUAL_COMPOSER_EXTENSIONS', 	'TS_VCSC_Set_Plugin_Options');
	...
	function TS_VCSC_Set_Plugin_Options() {
		...
		// Other Options
		add_option('ts_vcsc_extend_settings_dataRestore', 						0);
		...
		add_option('ts_vcsc_extend_settings_additionsSmoothSpeed',				'40');
		// Custom Post Types
