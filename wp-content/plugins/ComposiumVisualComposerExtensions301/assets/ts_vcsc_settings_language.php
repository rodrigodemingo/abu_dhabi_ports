...
<div id="ts-settings-language" class="tab-content">
	...
	<div class="ts-vcsc-section-content">
		...
		Some elements use key words or text strings on the front-end, mostly for control menus. Here, you can translate those key words if you want to show them in a different language.
	    </div>
	</div>
    </div>
    <div class="ts-vcsc-section-main">
    ...
    <div class="ts-vcsc-section-main">
	<div class="ts-vcsc-section-title ts-vcsc-section-show"><i class="dashicons-location-alt"></i>Google Map Phrases</div>
	<div class="ts-vcsc-section-content">
