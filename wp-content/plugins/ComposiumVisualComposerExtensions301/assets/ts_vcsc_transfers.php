<?php
	...
	$TS_VCSC_Social_Defaults 									= get_option('ts_vcsc_extend_settings_socialDefaults', '');
			...
			<div class="ts-vcsc-section-main">
				...
				<div class="ts-vcsc-section-content">
					<div style="margin-top: 10px;">
						...
						<a class="button-secondary" style="width: 200px; margin: 0 5px 0 0; text-align: center;" href="http://tekanewascripts.info/composer/manual/" target="_blank"><img src="<?php echo TS_VCSC_GetResourceURL('images/other/ts_vcsc_manual_icon_16x16.png'); ?>" style="width: 16px; height: 16px; margin-right: 10px;">Manual</a>
