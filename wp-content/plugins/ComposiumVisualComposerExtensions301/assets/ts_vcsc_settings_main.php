<?php
	...
	if (isset($_POST['Submit'])) {
		...
		if (trim ($_POST['ts_vcsc_extend_settings_true']) == 1) {
			...
			update_option('ts_vcsc_extend_settings_dataRestore', 					intval(((isset($_POST['ts_vcsc_extend_settings_dataRestore'])) 				?	$_POST['ts_vcsc_extend_settings_dataRestore'] 				: 0)));
			...
			// Save Settings for Visual Composer Fonts
		...
		// Retrieve Setting for Visual Composer Fonts
		if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_EditorIconFontsInternal == "true") {
			foreach ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_Composer_Font_Settings as $Icon_Font => $iconfont) {
				$default = ($iconfont['default'] == "true" ? 1 : 0);
				${'ts_vcsc_extend_settings_tinymce' . $iconfont['setting'] . ''}	= get_option('ts_vcsc_extend_settings_tinymce' . $iconfont['setting'],		$default);
	...
	<div class="wrapper ts-vcsc-settings-group-container">		
		<div class="ts-vcsc-settings-group-header">
			<div class="display_header">
				<h2><span class="dashicons dashicons-admin-generic"></span>Visual Composer Extensions - Options Panel</h2>
			</div>
			<div class="clear"></div>
		</div>
		...
		<div id="v-nav" class="ts-vcsc-settings-group-tabs">
			<ul id="v-nav-main" data-type="settings">
				...
				<li id="link-ts-settings-iconfont" 		data-tab="ts-settings-iconfont" 		data-order="3"		data-name="Font Manager"			class="link-data"><i class="dashicons-index-card"></i>Font Manager<span id="errorTab3" class="errorMarker"></span></li>
				<?php
					if (((get_option('ts_vcsc_extend_settings_extended', 0) == 1) && (get_option('ts_vcsc_extend_settings_fontimport', 1) == 1)) || ((get_option('ts_vcsc_extend_settings_extended', 0) == 0))) {
						echo '<a href="admin.php?page=TS_VCSC_Uploader" target="_parent" style="color: #000000;">';
							echo '<li id="link-ts-settings-import" 				data-tab="ts-settings-import" 			data-order="4"		data-name="Import Font"				class="link-url"><i class="dashicons-upload"></i>Import Font<span id="errorTab4" class="errorMarker"></span></li>';
						echo '</a>';
					}
				?>
				...
				<?php
					if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_IconicumStandard == "false") {
						if ($VISUAL_COMPOSER_EXTENSIONS->TS_VCSC_IconicumActivated == "true") {
					...
					if (current_user_can('manage_options')) {
						if (((get_option('ts_vcsc_extend_settings_extended', 0) == 1) && (get_option('ts_vcsc_extend_settings_codeeditors', 1) == 1)) || ((get_option('ts_vcsc_extend_settings_extended', 0) == 0))) {
							echo '<a href="admin.php?page=TS_VCSC_CSS" target="_parent" style="color: #000000;">';
								echo '<li id="link-ts-settings-customcss" 	data-tab="ts-settings-customcss"	data-order="12"		data-name="Add Custom CSS"			class="link-url"><i class="dashicons-media-code"></i>Custom CSS<span id="errorTab12" class="errorMarker"></span></li>';
							echo '</a>';
							echo '<a href="admin.php?page=TS_VCSC_JS" target="_parent" style="color: #000000;">';
								echo '<li id="link-ts-settings-customjs" 	data-tab="ts-settings-customjs" 	data-order="13"		data-name="Add Custom JS"			class="link-url"><i class="dashicons-media-code"></i>Custom JS<span id="errorTab13" class="errorMarker"></span></li>';
							echo '</a>';
						}
						if (function_exists('file_get_contents')) {
							echo '<li id="link-ts-settings-changelog" 		data-tab="ts-settings-changelog" 	data-order="14"		data-name="Changelog"				class="link-data"><i class="dashicons-media-text"></i>Changelog<span id="errorTab14" class="errorMarker"></span></li>';
						}
						echo '<a href="admin.php?page=TS_VCSC_System" target="_parent" style="color: #000000;">';
							echo '<li id="link-ts-settings-systeminfo" 		data-tab="ts-settings-systeminfo" 	data-order="15"		data-name="System Info"				class="link-url"><i class="dashicons-desktop"></i>System Info<span id="errorTab15" class="errorMarker"></span></li>';
						echo '</a>';
						if (get_option('ts_vcsc_extend_settings_extended', 0) == 0) {
							echo '<a href="admin.php?page=TS_VCSC_License" target="_parent" style="color: #000000;">';
								echo '<li id="link-ts-settings-license" 	data-tab="ts-settings-license"		data-order="16"		data-name="Licence Key"				class="link-url"><i class="dashicons-admin-network"></i>License Key<span id="errorTab16" class="errorMarker"></span></li>';
							echo '</a>';
						}
						echo '<a href="admin.php?page=TS_VCSC_Transfers" target="_parent" style="color: #000000;">';
							echo '<li id="link-ts-settings-transfers" 		data-tab="ts-settings-transfers"	data-order="17"		data-name="Transfer Settings"		class="link-url last"><i class="dashicons-migrate"></i>Transfer Settings<span id="errorTab17" class="errorMarker"></span></li>';
						echo '</a>';
					}
				?>
			</ul>
