<?php
    if (function_exists('vc_map')) {		
		$TS_VCSC_Default_Colors = array(
			__( 'Default Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-default",
			__( 'Sun Flower Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-color-sun-flower",
			__( 'Orange Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-orange-flat",
			__( 'Carot Flat', "ts_visual_composer_extend" )     		=> "ts-dual-buttons-color-carrot-flat",
			__( 'Pumpkin Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-pumpkin-flat",
			__( 'Alizarin Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-alizarin-flat",
			__( 'Pomegranate Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-color-pomegranate-flat",
			__( 'Turquoise Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-turquoise-flat",
			__( 'Green Sea Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-green-sea-flat",
			__( 'Emerald Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-emerald-flat",
			__( 'Nephritis Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-nephritis-flat",
			__( 'Peter River Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-color-peter-river-flat",
			__( 'Belize Hole Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-color-belize-hole-flat",
			__( 'Amethyst Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-amethyst-flat",
			__( 'Wisteria Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-wisteria-flat",
			__( 'Wet Asphalt Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-color-wet-asphalt-flat",
			__( 'Midnight Blue Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-color-midnight-blue-flat",
			__( 'Clouds Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-clouds-flat",
			__( 'Silver Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-silver-flat",
			__( 'Concrete Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-concrete-flat",
			__( 'Asbestos Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-asbestos-flat",
			__( 'Graphite Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-color-graphite-flat",
		);
		$TS_VCSC_Hover_Colors = array(
			__( 'Default Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-default ts-dual-buttons-hover-default",
			__( 'Sun Flower Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-preview-sun-flower ts-dual-buttons-hover-sun-flower",
			__( 'Orange Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-orange-flat ts-dual-buttons-hover-orange-flat",
			__( 'Carot Flat', "ts_visual_composer_extend" )     		=> "ts-dual-buttons-preview-carrot-flat ts-dual-buttons-hover-carrot-flat",
			__( 'Pumpkin Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-pumpkin-flat ts-dual-buttons-hover-pumpkin-flat",
			__( 'Alizarin Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-alizarin-flat ts-dual-buttons-hover-alizarin-flat",
			__( 'Pomegranate Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-preview-pomegranate-flat ts-dual-buttons-hover-pomegranate-flat",
			__( 'Turquoise Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-turquoise-flat ts-dual-buttons-hover-turquoise-flat",
			__( 'Green Sea Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-green-sea-flat ts-dual-buttons-hover-green-sea-flat",
			__( 'Emerald Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-emerald-flat ts-dual-buttons-hover-emerald-flat",
			__( 'Nephritis Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-nephritis-flat ts-dual-buttons-hover-nephritis-flat",
			__( 'Peter River Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-preview-peter-river-flat ts-dual-buttons-hover-peter-river-flat",
			__( 'Belize Hole Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-preview-belize-hole-flat ts-dual-buttons-hover-belize-hole-flat",
			__( 'Amethyst Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-amethyst-flat ts-dual-buttons-hover-amethyst-flat",
			__( 'Wisteria Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-wisteria-flat ts-dual-buttons-hover-wisteria-flat",
			__( 'Wet Asphalt Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-preview-wet-asphalt-flat ts-dual-buttons-hover-wet-asphalt-flat",
			__( 'Midnight Blue Flat', "ts_visual_composer_extend" )		=> "ts-dual-buttons-preview-midnight-blue-flat ts-dual-buttons-hover-midnight-blue-flat",
			__( 'Clouds Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-clouds-flat ts-dual-buttons-hover-clouds-flat",
			__( 'Silver Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-silver-flat ts-dual-buttons-hover-silver-flat",
			__( 'Concrete Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-concrete-flat ts-dual-buttons-hover-concrete-flat",
			__( 'Asbestos Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-asbestos-flat ts-dual-buttons-hover-asbestos-flat",
			__( 'Graphite Flat', "ts_visual_composer_extend" )			=> "ts-dual-buttons-preview-graphite-flat ts-dual-buttons-hover-graphite-flat",
		);		
        vc_map( array(
