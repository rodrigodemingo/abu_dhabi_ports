    ...
    if (function_exists('vc_map')) {
        vc_map( array(
            ...
            "params"                        => array(
                ...
                array(
                    "type"                  => "switch",
					"heading"			    => __( "Custom Width", "ts_visual_composer_extend" ),
					"param_name"		    => "lightbox_custom_width",
                    "value"                 => "false",
                    "on"				    => __( 'Yes', "ts_visual_composer_extend" ),
                    "off"				    => __( 'No', "ts_visual_composer_extend" ),
                    "style"				    => "select",
                    "design"			    => "toggle-light",
					"description"		    => __( "Switch the toggle if you want to apply a custom width to the modal popup element (will otherwise be determined by script).", "ts_visual_composer_extend" ),
                    "dependency"            => ""
                ),
                array(
                    "type"                  => "nouislider",
                    ...
                    "step"                  => "1",
                    "unit"                  => 'px',
                    "description"           => __( "Define the custom width for the modal popup (script will adjust if necessary, based on actual screen size).", "ts_visual_composer_extend" ),
                    "dependency"            => array( 'element' => "lightbox_custom_width", 'value' => 'true' )
                ),
                array(
                    "type"                  => "switch",
					"heading"			    => __( "Custom Height", "ts_visual_composer_extend" ),
					"param_name"		    => "lightbox_custom_height",
                    "value"                 => "false",
                    "on"				    => __( 'Yes', "ts_visual_composer_extend" ),
                    "off"				    => __( 'No', "ts_visual_composer_extend" ),
                    "style"				    => "select",
                    "design"			    => "toggle-light",
					"description"		    => __( "Switch the toggle if you want to apply a custom height to the modal popup element (will otherwise be determined by script).", "ts_visual_composer_extend" ),
                    "dependency"            => ""
                ),
                array(
                    "type"                  => "nouislider",
                    ...
                    "step"                  => "1",
                    "unit"                  => 'px',
                    "description"           => __( "Define the custom height for the modal popup (script will adjust if necessary, based on actual screen size).", "ts_visual_composer_extend" ),
                    "dependency"            => array( 'element' => "lightbox_custom_height", 'value' => 'true' )
                ),*/	
                array(
                    "type"                  => "dropdown",
