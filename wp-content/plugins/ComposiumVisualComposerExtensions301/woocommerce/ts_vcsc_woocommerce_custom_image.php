	...
	class TS_WooCommerce_ImageGrid_Basic {
        ...
        function TS_VCSC_WooCommerce_ImageGrid_Basic_Function ($atts, $content = null) {
			...
			if (function_exists('vc_shortcode_custom_css_class')) {
				$css_class 	= apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $el_class . ' ts-image-link-grid-frame ' . vc_shortcode_custom_css_class($css, ' '), 'TS_VCSC_WooCommerce_ImageGrid_Basic', $atts);
			} else {
