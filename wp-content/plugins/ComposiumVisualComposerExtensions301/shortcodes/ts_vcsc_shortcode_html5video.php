<?php
	...
	function TS_VCSC_HTML5_Video_Function ($atts, $content = null) {
		...
		if ($content_open == "true") {
			...
			$modal_openclass				= "nch-lightbox-html5";
			$modal_hideclass				= "";
		}
		...
		if ($content_lightbox == "true") {
			if ($content_trigger == "poster") {
				if ($popup_tooltipcontent != '') {
					$output .= '<div class="' . $modal_id . '-parent nch-holder ' . $modal_hideclass . ' ' . $popup_tooltipclasses . '" ' . $popup_tooltipcontent . ' style="margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px; ' . $parent_dimensions . '">';
						$output .= '<div id="' . $modal_id . '-trigger" class="' . $el_class . ' nchgrid-item nchgrid-tile nch-lightbox-modal nch-lightbox-video ' . $css_class . '" style="width: 100%; height: 100%;">';
				} else {
						$output .= '<div id="' . $modal_id . '-trigger" class="' . $modal_id . '-parent nch-holder ' . $modal_hideclass . ' ' . $el_class . ' nchgrid-item nchgrid-tile nch-lightbox-modal nch-lightbox-video ' . $css_class . '" style="margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px; ' . $parent_dimensions . '">';
				}
			...
			} else if ($content_trigger == "default") {
			...
			$output .= '<div id="' . $modal_id . '" class="ts-modal-content nch-hide-if-javascript" style="display: none;">';
				...
				$output .= '<div class="ts-modal-white-frame">';
					$output .= '<div class="ts-modal-white-inner">';			
						$output .= '<div id="' . $modal_id . '_video" class="ts_video_container ts_html5_video_frame" style="border: 1px solid #DADADA;">';
			...
			$output .= '<div id="' . $modal_id . '_video" class="ts_video_container ts_html5_video_frame ' . $el_class . ' ' . $css_class . '" style="border: 1px solid #DADADA; ' . $container_adjust . ' ' . $container_fixed . '">';
