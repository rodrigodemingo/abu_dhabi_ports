<?php
	...
	function TS_VCSC_Textillate_Function ($atts) {
		...
		$style_setting					= 'color: ' . $font_color . ' !important; font-size: ' . $font_size . 'px; line-height: ' . $font_size . 'px; font-weight: ' . $font_weight . '; text-align: ' . $font_align . '; margin-top: ' . $margin_top . 'px; margin-bottom: ' . $margin_bottom . 'px;';
