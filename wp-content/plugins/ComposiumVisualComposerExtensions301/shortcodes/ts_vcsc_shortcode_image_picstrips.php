	...
	function TS_VCSC_Image_Picstrips_Function ($atts) {
		...
		if ($hover_frontent == "false") {
			if (($hover_event != "none") && ($hover_event == "popup")) {
				...
				// iFrame Popup
				$linkstringStart .= '<a id="' . $picstrips_image_id . '-trigger" href="' . $a_href . '" target="' . $a_target . '" class="ts-hover-image-link ' . $picstrips_image_id . '-parent nch-holder nch-lightbox-media" ' . $lightbox_dimensions . ' style="" data-title="' . $hover_title . '" data-type="iframe" rel="' . ($lightbox_group == "true" ? "nachogroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" ' . $nacho_color . '">';
				$linkstringEnd	 .= '</a>';
			} else if (($hover_event != "none") && ($hover_event == "image")) {
				// Image Popup
				$linkstringStart .= '<a id="' . $picstrips_image_id . '-trigger" href="' . $picstrips_image[0] . '" class="ts-hover-image-link ' . $picstrips_image_id . '-parent nch-holder nch-lightbox-media" ' . $lightbox_dimensions . ' style="" data-title="' . $hover_title . '" rel="' . ($lightbox_group == "true" ? "nachogroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" ' . $nacho_color . '">';
				$linkstringEnd	 .= '</a>';
				...
				// HTML5 Video Popup
				$linkstringStart .= '<a id="' . $picstrips_image_id . '-trigger" href="#' . $modal_id . '" class="ts-hover-image-link ' . $picstrips_image_id . '-parent nch-holder nch-lightbox-media" ' . $lightbox_dimensions . ' style="" data-title="' . $hover_title . '" data-type="html" rel="' . ($lightbox_group == "true" ? "nachogroup" : $lightbox_group_name) . '" data-effect="' . $lightbox_effect . '" data-duration="' . $lightbox_speed . '" ' . $nacho_color . '">';
				$linkstringEnd	 .= '</a>';
