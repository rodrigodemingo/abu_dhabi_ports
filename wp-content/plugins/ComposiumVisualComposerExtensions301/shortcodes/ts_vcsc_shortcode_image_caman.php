		...
		if (($tooltip_css == "true") && (strlen($tooltip_content) != 0)) {
			...
			$output .= '<div id="' . $caman_image_id . '" data-trigger="' . $switch_trigger . '" class="ts-image-caman-frame ' . $el_class . ' ts-imageswitch ts-imageswitch-before ' . $caman_switch_type . ' ' . $switch_trigger . ' ' . $css_class . '"' . ($tooltip_css == "false" ? $caman_tooltipcontent : "") . ' data-number="' . $caman_number . '" data-effect="' . $caman_effect . '" style="width: 100%; height: 100%; ' . $caman_margin . $caman_padding .'">';
				if ($caman_switch_allow == "true") {
					$output .= '<img id="ts-image-caman-original-' . $caman_number . '" class="ts-image-caman-original ts-imageswitch__after" src="' . $caman_image[0] . '" style="width: 100%; height: auto;" alt="' . basename($caman_image[0], "." . $image_extension) . '" data-width="" data-height="" data-number="' . $caman_number . '" data-effect="' . $caman_effect . '"/>';
					$output .= '<img id="ts-image-caman-canvas-' . $caman_number . '" class="ts-image-caman-canvas ts-imageswitch__before ' . ($caman_switch_type == "ts-imageswitch-fade" ? "active" : "") . '" src="' . $caman_image[0] . '" style="width: 100%; height: auto;" alt="' . basename($caman_image[0], "." . $image_extension) . '" data-camanwidth="" data-camanheight="" data-number="' . $caman_number . '" data-effect="' . $caman_effect . '"/>';
				} else {
					$output .= '<img id="ts-image-caman-original-' . $caman_number . '" class="ts-image-caman-original" src="' . $caman_image[0] . '" style="width: 100%; height: auto; display: none;" alt="' . basename($caman_image[0], "." . $image_extension) . '" data-width="" data-height="" data-number="' . $caman_number . '" data-effect="' . $caman_effect . '"/>';
					$output .= '<img id="ts-image-caman-canvas-' . $caman_number . '" class="ts-image-caman-canvas" src="' . $caman_image[0] . '" style="width: 100%; height: auto; cursor: default;" alt="' . basename($caman_image[0], "." . $image_extension) . '" data-camanwidth="" data-camanheight="" data-number="' . $caman_number . '" data-effect="' . $caman_effect . '"/>';
				}
