<?php
	...
	function TS_VCSC_Icon_Title_Function ($atts) {
		...
		if ($icon_location == 'left') {
			...
			$icon_position					= 'position: absolute; left: 0; top: 50%; margin-top: -' . (($icon_size_slide + $icon_padding * 2) / 2) . 'px;';
			$title_margin					= 'margin-left: ' . (($icon_size_slide + $icon_padding * 2) + $icon_margin) . 'px;';
			$title_align					= $align;
		} else if ($icon_location == 'right') {
			$icon_alignment 				= 'float: right;';
			$icon_position					= 'position: absolute; right: 0; top: 50%; margin-top: -' . (($icon_size_slide + $icon_padding * 2) / 2) . 'px;';
